...
final class NotchPocketViewModel: NSObject, ObservableObject {
    ...
    func close() {
        ...
        if Defaults[.notchPocketShelf] && !ShelfStateViewModel.shared.isEmpty && Defaults[.openShelfByDefault] {
