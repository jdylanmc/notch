...
struct NotchPocketApp: App {
    ...
    var body: some Scene {
        MenuBarExtra("Notch Pocket", systemImage: "sparkle", isInserted: $showMenuBarIcon) {
            Button("Settings") {
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    var viewModels: [String: NotchPocketViewModel] { windowManager.viewModels }
    var window: NSWindow? { windowManager.window }
    var vm: NotchPocketViewModel { windowManager.primaryViewModel }
    ...
    func playWelcomeSound() {
        ...
        audioPlayer.play(fileName: "notchPocket", fileExtension: "m4a")
    }
