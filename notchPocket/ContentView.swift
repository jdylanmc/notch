...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .onChange(of: dropInteraction.anyDropZoneTargeting) { _, isTargeted in
            ...
            if isTargeted {
                if Defaults[.notchPocketShelf] && vm.notchState == .closed {
                    if doOpen() {
    ...
    var dragDetector: some View {
        ...
        if Defaults[.notchPocketShelf] && vm.notchState == .closed && !shouldDisplayNowPlayingFallbackNotice {
            Color.clear
