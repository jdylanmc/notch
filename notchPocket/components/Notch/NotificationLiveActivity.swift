...
struct NotificationExpandedView: View {
    ...
    var body: some View {
        ...
        .id(notification.id)
        .background(WindowAccessor { self.hostWindow = $0 as? NotchPocketSkyLightWindow })
        ...
        .onChange(of: replyFocused) { _, focused in
            ...
            // NotchPocketSkyLightWindow.wantsKeyForTextInput.
...
/// NotchPocketSkyLightWindow can't become key by default (a click on the notch must
