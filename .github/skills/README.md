...
The separate [personal and retained workflow packets](../../.agents/skills/README.md)
provide engineering/productivity workflows under `.agents/skills`, including
the user's `joe-mode` and personal replacements for five legacy skill names.
